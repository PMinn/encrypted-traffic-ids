...
class Cross_dataset_validation:
    ...
    def validation(self):
        ...
        if len(unique_labels) < len(self.classes):
            print("Warning: Not all classes are present in the validation data.")
        ...
        for i, c in enumerate(self.classes):
            if class_total[i] == 0:
                print(f'Valid Accuracy of {c}: N/A (no samples)')
                continue
...
if __name__ == "__main__":
    ...
    # [好像不用]先將多分類測試集合併成二分類
    # merge_testing_data(
    #     base_dir = "/sdc1/ytlindata/USTC-TFC2016/120_5_flows_delall/",
    #     files = [
    ...
    #     ]
    # )
    # test_path = '/sdc1/ytlindata/USTC-TFC2016/120_5_flows_delall/binary_sampling'
    # 多分類
    test_path = '/sdc1/ytlindata/USTC-TFC2016/120_5_flows_delall/test/sampling/'

    model_path = "/sdc1/ytlindata/USTC-TFC2016/ViT/1Dmulti_result(120delall)/20250825-075445/pth/model-best_val_acc.pth"
