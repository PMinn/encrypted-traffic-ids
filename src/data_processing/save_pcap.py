...
def save_pcap(pcap_file: Path, output_file: Path, remove_original: bool = False):
    """
...
def copy_pcap(src_file: Path, dest_file: Path):
    """
        複製 pcap 檔案到指定位置
        Args:
...
def pcapng_to_pcap(input_file: Path, output_file: Path):
    """
