...
class FlowStats:
    ...
    def to_features(self) -> dict[str, float]:
        ...
        # Flow IAT
        _, flow_iat_mean, flow_iat_std, flow_iat_max, flow_iat_min = self._iat(
            self.timestamps
        )
        # Fwd IAT
...
def extract_flow_features_73(pkts: PacketList) -> dict[str, float] | None:
    """
...
def get_feature_names_73() -> list[str]:
    """
    取得特徵名稱列表
    Returns:
...
def get_log_scale_features_name_73() -> list[str]:
    return [
        "Flow Duration",
        "Total Length of Fwd Packets",
        "Total Length of Bwd Packets",
...
def get_std_scale_features_name_73() -> list[str]:
    return [
        "Total Fwd Packets",
        "Total Backward Packets",
        "Fwd Packet Length Max",
